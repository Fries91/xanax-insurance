// ==UserScript==
// @name         Sinner's Insurance 7DS PC
// @namespace    fries91-xanax-insurance
// @version      4.0.3
// @description  Sinner's Insurance PC + Tampermonkey Edition
...
// @updateURL    https://raw.githubusercontent.com/Fries91/xanax-insurance/main/static/xanax-insurance-pc.user.js
// @downloadURL  https://raw.githubusercontent.com/Fries91/xanax-insurance/main/static/xanax-insurance-pc.user.js
...
(function () {
    ...
    function finishLoginSuccess(user, roleLabel) {
        ...
        if (typeof fetchAlertsState === 'function') fetchAlertsState();
    ...
    function bindEvents() {
        ...
        if (singleLoginBtn) singleLoginBtn.addEventListener('click', function () { maybeAutoLogin(true).then(function (ok) { if (!ok) singleBackendLogin(); }); });
...
#si-pda-launcher{left:18px!important;bottom:18px!important;width:154px!important;height:34px!important;}
#si-pda-launcher button{width:154px!important;height:34px!important;font-size:12px!important;letter-spacing:.2px!important;cursor:pointer!important;}
#si-pda-overlay{left:24px!important;right:auto!important;top:84px!important;bottom:24px!important;width:min(1080px,calc(100vw - 48px))!important;border-radius:16px!important;}
#si-pda-overlay .si-head{padding:12px 14px!important;}
#si-pda-overlay .si-title{font-size:16px!important;}
#si-pda-overlay .si-sub{font-size:11px!important;}
#si-pda-overlay .si-close{width:36px!important;height:36px!important;font-size:20px!important;cursor:pointer!important;}
#si-pda-overlay .si-tabs{grid-template-columns:repeat(7,minmax(0,1fr))!important;gap:6px!important;padding:10px 10px 0!important;}
#si-pda-overlay .si-tab{min-height:34px!important;font-size:11px!important;cursor:pointer!important;}
#si-pda-overlay .si-body{padding:10px!important;gap:10px!important;}
#si-pda-overlay .si-card{padding:12px!important;}
#si-pda-overlay .si-card-title{font-size:12px!important;}
#si-pda-overlay .si-tiles{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;gap:8px!important;}
#si-pda-overlay .si-tile-num{font-size:18px!important;}
#si-pda-overlay .si-tile-label{font-size:11px!important;}
#si-pda-overlay .si-row{padding:8px 0!important;}
#si-pda-overlay .si-label{font-size:11px!important;}
#si-pda-overlay .si-text{font-size:13px!important;line-height:1.5!important;}
#si-pda-overlay .si-btnrow{flex-wrap:wrap!important;gap:8px!important;}
#si-pda-overlay .si-btnstack{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;}
#si-pda-overlay .si-btn{min-height:34px!important;padding:0 12px!important;font-size:12px!important;cursor:pointer!important;}
#si-pda-overlay .si-input,#si-pda-overlay .si-textarea{font-size:14px!important;padding:10px 12px!important;}
#si-pda-overlay .si-textarea{min-height:110px!important;resize:vertical!important;}
#si-pda-overlay .si-wrath-wrap{grid-template-columns:repeat(2,minmax(0,1fr))!important;}
}
`);
