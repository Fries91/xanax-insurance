...
// @downloadURL  https://xanax-insurance.onrender.com/static/xanax-insurance.user.js
// @updateURL    https://xanax-insurance.onrender.com/static/xanax-insurance.user.js
        ...
        try {
            if (typeof Notification !== 'undefined') {
                ...
                if (Notification.permission !== 'denied') {
                    Notification.requestPermission().th       };
                }
                return;
            }
            if (startMs <= now && (!endMs || endMs > now)) {
