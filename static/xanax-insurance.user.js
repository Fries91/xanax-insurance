  ...
  #si-7ds-overlay .si-7ds-tab {
    ...
    function renderTabContent() {
        ...
        return ''
            ...
            +   '<div class="si-7ds-text">Paste your Torn API key below, then tap <strong>Login With API Key</strong>. The script will detect member or admin access automatically.</div>'
            +   '<div class="si-7ds-field">'
            ...
            +   '</div>'
            +   '<div class="si-7ds-field">'
            +     '<label class="si-7ds-label" for="si-faction-id-lock">Faction ID</label>'
            +     '<input id="si-faction-id-lock" class="si-7ds-input" type="text" inputmode="numeric" value="' + esc(factionIdLock || '49384') + '" placeholder="49384">'
            +   '</div>'
            +   '<div class="si-7ds-pillrow">'
            +     '<div class="si-7ds-pill">Access: ' + esc(getRequiredUserSelections()) + '</div>'
            +     '<div class="si-7ds-pill">Faction Lock: ' + esc(factionIdLock || '49384') + '</div>'
            +   '</div>'
            +   '<div class="si-7ds-plan-actions">'
            +     '<button type="button" class="si-7ds-btn" data-action="login-api">Login With API Key</button>'
            +     '<button type="button" class="si-7ds-btn alt" data-action="open-api-key-page">Get / Make API Key</button>'
            +   '</div>'
            +   '<div class="si-7ds-plan-actions">'
            ...
            +     '<div class="si-7ds-list-item"><strong>1.</strong> Paste your API key.</div>'
            +     '<div class="si-7ds-list-item"><strong>2.</strong> Tap Login With API Key.</div>'
            +     '<div class="si-7ds-list-item"><strong>3.</strong> Go to Plans and arm the plan you want.</div>'
            +     '<div class="si-7ds-list-item"><strong>4.</strong> If your key resolves as admin, the Admin tab appears automatically.</div>'
            +   '</div>'
            + '</div>'
            + '<div class="si-7ds-card">'
            ...
            +   '<div class="si-7ds-setting-row"><div class="si-7ds-setting-label">Overlay</div><div class="si-7ds-setting-value">' + (isAdmin() ? '5 tabs active' : '4 tabs active') + '</div></div>'
            ...
            +   '<div class="si-7ds-setting-row"><div class="si-7ds-setting-label">Visibility</div><div class="si-7ds-setting-value">Admin tools stay hidden for members</div></div>'
            + '</div>';
    }
